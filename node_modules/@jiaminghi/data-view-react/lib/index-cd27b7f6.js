...
var _slicedToArray2 = index$2._interopRequireDefault(index$2.require$$1);

var _toConsumableArray2 = index$2._interopRequireDefault(index$2.require$$3);
...
var _polylineToBezierCurve = index$2._interopRequireDefault(polylineToBezierCurve_1);
...
var _bezierCurve2 = index$2._interopRequireDefault(lib);
...
var circle = {
  ...
  hoverCheck: function hoverCheck(position, _ref4) {
    ...
    var rx = shape.rx,
        ry = shape.ry,
        r = shape.r;
    return (0, index$2._util.checkPointIsInCircle)(position, rx, ry, r);
  },
...
var ellipse = {
  ...
  hoverCheck: function hoverCheck(position, _ref11) {
    ...
    var distance = (0, index$2._util.getTwoPointDistance)(position, leftFocusPoint) + (0, index$2._util.getTwoPointDistance)(position, rightFocusPoint);
    return distance <= 2 * a;
  },
...
var rect = {
  ...
  hoverCheck: function hoverCheck(position, _ref18) {
    ...
    var x = shape.x,
        ...
        w = shape.w,
        h = shape.h;
    return (0, index$2._util.checkPointIsInRect)(position, x, y, w, h);
  },
...
var ring = {
  ...
  hoverCheck: function hoverCheck(position, _ref25) {
    ...
    var distance = (0, index$2._util.getTwoPointDistance)(position, [rx, ry]);
...
var arc = {
  ...
  hoverCheck: function hoverCheck(position, _ref32) {
    ...
    return !(0, index$2._util.checkPointIsInSector)(position, rx, ry, insideRadius, startAngle, endAngle, clockWise) && (0, index$2._util.checkPointIsInSector)(position, rx, ry, outsideRadius, startAngle, endAngle, clockWise);
  },
...
var sector = {
  ...
  hoverCheck: function hoverCheck(position, _ref39) {
    ...
    var rx = shape.rx,
        ...
        endAngle = shape.endAngle,
        clockWise = shape.clockWise;
    return (0, index$2._util.checkPointIsInSector)(position, rx, ry, r, startAngle, endAngle, clockWise);
  },
...
var regPolygon = {
  ...
  draw: function draw(_ref44, _ref45) {
    ...
    if (!cache.points || cache.rx !== rx || cache.ry !== ry || cache.r !== r || cache.side !== side) {
      var _points = (0, index$2._util.getRegularPolygonPoints)(rx, ry, r, side);
  ...
  hoverCheck: function hoverCheck(position, _ref46) {
    ...
    var points = cache.points;
    return (0, index$2._util.checkPointIsInPolygon)(position, points);
  },
...
var polyline = {
  ...
  draw: function draw(_ref53, _ref54) {
    ...
    var points = shape.points,
        close = shape.close;
    if (lineWidth === 1) points = (0, index$2._util.eliminateBlur)(points);
    (0, canvas.drawPolylinePath)(ctx, points);
  ...
  hoverCheck: function hoverCheck(position, _ref55) {
    ...
    if (close) {
      ...
      return (0, index$2._util.checkPointIsNearPolyline)(position, points, lineWidth);
    }
  },
...
var smoothline = {
  ...
  draw: function draw(_ref62, _ref63) {
    ...
    if (!cache.points || cache.points.toString() !== points.toString()) {
      ...
      Object.assign(cache, {
        points: (0, index$2._util.deepClone)(points, true),
  ...
  hoverCheck: function hoverCheck(position, _ref64) {
    ...
    if (close) {
      return (0, index$2._util.checkPointIsInPolygon)(position, hoverPoints);
    } else {
      return (0, index$2._util.checkPointIsNearPolyline)(position, hoverPoints, lineWidth);
    }
  },
...
var _classCallCheck2 = index$2._interopRequireDefault(classCallCheck);
...
Style.prototype.colorProcessor = function (style) {
  ...
  var processor = reverse ? index$3.lib.getColorFromRgbValue : index$3.lib.getRgbaValue;
...
function initGraphStyle(ctx, style) {
  ...
  ctx.fillStyle = (0, index$3.lib.getColorFromRgbValue)(fill);
  ctx.strokeStyle = (0, index$3.lib.getColorFromRgbValue)(stroke);
  ctx.shadowColor = (0, index$3.lib.getColorFromRgbValue)(shadowColor);
...
function initGradient(ctx, style) {
  ...
  gradientColor = gradientColor.map(function (c) {
    return (0, index$3.lib.getColorFromRgbValue)(c);
  });
...
Style.prototype.getStyle = function () {
  var clonedStyle = (0, index$2._util.deepClone)(this, true);
...
var _typeof2 = index$2._interopRequireDefault(index$2.require$$0);

var _curves = index$2._interopRequireDefault(curves);
...
var _regenerator = index$2._interopRequireDefault(regenerator);

var _asyncToGenerator2 = index$2._interopRequireDefault(asyncToGenerator);
...
var _style = index$2._interopRequireDefault(style_class);

var _transition = index$2._interopRequireDefault(lib$1);
...
var Graph = function Graph(graph, config) {
  ...
  config = (0, index$2._util.deepClone)(config, true);
  var defaultConfig = {
    /**
...
Graph.prototype.hoverCheckProcessor = function (position, _ref) {
  ...
  if (graphCenter) {
    if (rotate) position = (0, index$2._util.getRotatePointPos)(-rotate, position, graphCenter);
    if (scale) position = (0, index$2._util.getScalePointPos)(scale.map(function (s) {
      return 1 / s;
    }), position, graphCenter);
    if (translate) position = (0, index$2._util.getTranslatePointPos)(translate.map(function (v) {
      return v * -1;
    }), position);
  }

  if (hoverRect) return index$2._util.checkPointIsInRect.apply(void 0, [position].concat((0, _toConsumableArray2["default"])(hoverRect)));
...
Graph.prototype.attr = function (attrName) {
  ...
  if (isObject) change = (0, index$2._util.deepClone)(change, true);
    ...
    return _regenerator["default"].wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 4:
            change = (0, index$2._util.deepClone)(change, true);
...
var _defineProperty2 = index$2._interopRequireDefault(defineProperty);

var _toConsumableArray2 = index$2._interopRequireDefault(index$2.require$$3);

var _classCallCheck2 = index$2._interopRequireDefault(classCallCheck);

var _color = index$2._interopRequireDefault(index$3.lib);

var _bezierCurve = index$2._interopRequireDefault(lib);



var _graphs = index$2._interopRequireDefault(graphs_1);

var _graph = index$2._interopRequireDefault(graph_class);
...
CRender.prototype.clone = function (graph) {
  ...
  clonedGraph = (0, index$2._util.deepClone)(clonedGraph, true);
...
var _crender = index$2._interopRequireDefault(crender_class);
...
exports._color = index$3.lib;
exports._graphs = graphs_1;
exports.lib = lib$2;
exports.require$$0 = defineProperty;
exports.require$$1 = classCallCheck;
exports.require$$4 = lib;
//# sourceMappingURL=index-cd27b7f6.js.map
